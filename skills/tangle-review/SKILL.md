...
This is the **manual fallback/audit path**: normal reviews happen via the Codex loop inside `tangle-2-implement`. Use this skill to audit a past version, review unplanned work, or replace the Codex loop when it is unavailable.
...
4. @.claude/skills/tangle-review/checklist.md — **single source of truth** for review criteria, severity classification, and approval gate
...
Render the skeleton from `@.claude/skills/tangle-review/cr-template.md`:

...
1. `docs/ARCHI.md`
2. `.claude/skills/tangle-review/checklist.md` — single source of truth for the review checklist, severity classification, and approval gate. Do NOT read `.claude/skills/tangle-review/SKILL.md`.
